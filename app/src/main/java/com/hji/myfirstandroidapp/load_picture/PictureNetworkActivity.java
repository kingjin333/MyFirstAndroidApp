...
//        StaggeredGridLayoutManager layoutManager = new StaggeredGridLayoutManager(2, StaggeredGridLayoutManager.VERTICAL);
    ...
    private static class PictureRecyclerViewAdapter extends RecyclerView.Adapter<PictureRecyclerViewAdapter.MyViewHolder> {
        ...
        public PictureRecyclerViewAdapter(final Context context, Cursor cursor) {
            mCursor = cursor;
            ...
            mAsyncBitmapLoader.setBitmapLoadListener(new AsyncBitmapLoader.BitmapLoadListener() {
                ...
                public Bitmap getBitmap(String key) {
                    ...
                    Request request = new Request.Builder().url("https://lh3.googleusercontent.com/-uJ68eHurhPE/Vmkp4xPty2I/AAAAAAAA790/nvjVQWbSGMw/s320/1449371154144.jpg")
                            .build();
